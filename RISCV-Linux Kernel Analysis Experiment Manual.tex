...
\extrainfo{向计算机的先贤致敬 —— Elon Li}

\setcounter{tocdepth}{3}

\logo{Tux.png}
\cover{rms-torvalds1.jpg}
...
\begin{lstlisting}
  ...
  all: mymain switch
  gcc ./mymain.o ./switch.o -o ./main
\end{lstlisting}

使用 ssh 连接好 visionFive2 好后，使用 scp 命令将 main.c 和 Makefile 上传到开发板上后，使用以下的命令进行编译将会本目录下生成一个名为 main 
的二进制文件，让我们来运行它，发现和我们想得一模一样。非常好！现在我们已经能理解线程是怎么切换的了。：
\begin{lstlisting}
  make all && ./main
\end{lstlisting}
